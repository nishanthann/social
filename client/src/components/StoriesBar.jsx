      ...
      <div className="flex gap-4 pb-5">
        ...
        >
          <div className="h-full flex flex-col items-center justify-center p-4">
            ...
            <p className="text-sm font-medium text-slate-700">Add Story</p>
          </div>
        </div>
        {/* Story cards 💛*/}
        {stories.map((story, index) => (
          <div
            ...
            className={`relative rounded-lg shadow min-w-30 max-w-30 max-h-40 hover:shadow-lg transition-all duration-200  bg-gradient-to-b from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-700 active:scale-95  cursor-pointer`}
            key={index}
          >
            <img
